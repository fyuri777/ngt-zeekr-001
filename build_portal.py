...
TAXONOMY = [
    {
        ...
        "priority": "HIGH",
        "items": [
            {"id": "1.1", "title": "Покупка из Китая — процесс, грей-импорт", "slug": None},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "2.6", "title": "Реальный пробег и SOC — сезонные различия", "slug": None},
            {"id": "2.7", "title": "V2L — машина как розетка", "slug": None},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "3.2", "title": "12В аккумулятор — логика подзарядки, OBD-донглы", "slug": None},
            {"id": "3.3", "title": "Здоровье ВВБ — хранение, режимы заряда", "slug": None},
            {"id": "3.4", "title": "Прогрев батареи — планирование поездки", "slug": None},
            {"id": "3.5", "title": "Аварийный запуск при севшем 12В", "slug": None},
        ],
    },
    {
        "id": 4,
        ...
        "priority": "HIGH",
        "items": [
            {"id": "4.1", "title": "OTA обновления — версии 5.x дорест / 6.x рест, ZDS", "slug": None},
            {"id": "4.2", "title": "Лучшие версии прошивок — консенсус", "slug": None},
            {"id": "4.3", "title": "Перезагрузки и лаги планшета", "slug": None},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "5.2", "title": "Сравнение русификаторов — Infohub, GMC, XMETA, ZeeAppStore", "slug": None},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "6.2", "title": "Замёрзшие двери и ручки зимой — профилактика", "slug": None},
            {"id": "6.3", "title": "Безрамочные окна — шум, конденсат, после мойки", "slug": None},
            {"id": "6.4", "title": "Аварийное открытие при севшем 12В", "slug": None},
        ],
    },
    {
        "id": 7,
        ...
        "priority": "MEDIUM",
        "items": [
            {"id": "7.1", "title": "Режимы вождения — ECO/Comfort/Sport/Snow, AWD", "slug": None},
            {"id": "7.2", "title": "Пневмоподвеска — режимы, перегрев, город vs трасса", "slug": None},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "8.3", "title": "Антифриз — практика замены (см. 3.1)", "slug": None},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "10.2", "title": "Прошивки — почему несовместимы", "slug": None},
            {"id": "10.3", "title": "Совместимость запчастей", "slug": None},
            {"id": "10.4", "title": "Различия зарядки — DC мощность", "slug": None},
